...
import { Building2, LogIn, Plus, Menu, X, LogOut, User, List, UserCircle, Heart } from 'lucide-react';
      ...
      <div className="">
        ...
        <nav role="navigation" aria-label="Main navigation" className="relative">
          ...
          <h1 className="text-lg sm:text-xl font-bold bg-gradient-to-r from-indigo-600 to-indigo-400 bg-clip-text text-transparent">
            <span className="sr-only">PG Finder - </span>PG Finder
          </h1>
            </Link>
          ...
          {/* Mobile navigation dropdown - only on mobile */}
          {!isAuthPage && (
            <div
          className={`md:hidden absolute right-0 left-0 top-full mt-2 transform transition-all duration-300 ease-in-out origin-top ${
