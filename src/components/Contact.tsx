      ...
      <section className="px-4 sm:px-6 lg:px-10 py-12 lg:py-16">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="relative">
            ...
            <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-[0_18px_45px_rgba(15,23,42,0.08)] border border-purple-50 p-6 sm:p-8 lg:p-10 grid grid-cols-1 lg:grid-cols-[1.05fr_minmax(0,0.95fr)] gap-8 lg:gap-10">
              {/* LEFT: Form */}
              <div>
