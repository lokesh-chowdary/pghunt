...
useEffect(() => {
  ...
  const structuredData = {
    ...
    '@type': 'AboutPage',
    name: 'About PG Finder',
    description: 'Learn about PG Finder - India\'s trusted platform for finding PG accommodations without brokerage fees. Verified listings, transparent pricing, and excellent customer support.',
  ...
  return (
    <>
      <SEO
        ...
        description="Learn about PG Finder - India's trusted platform for finding PG accommodations without brokerage fees. Verified listings, transparent pricing, and excellent customer support."
        keywords="about PG Finder, PG platform, no brokerage PG, verified PG listings"
        url="/about"
