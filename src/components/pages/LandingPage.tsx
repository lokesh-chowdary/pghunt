...
function LandingPage() {
  ...
  const structuredData = {
    ...
    description: 'Find verified PG accommodations in Mumbai, Delhi, Bangalore, Chennai, Pune, and Hyderabad. No brokerage fees, transparent pricing, and verified listings.',
    potentialAction: {
      '@type': 'SearchAction',
      target: {
        '@type': 'EntryPoint',
