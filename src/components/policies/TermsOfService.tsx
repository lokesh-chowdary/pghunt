...
useEffect(() => {
  ...
  return (
    <>
      <SEO
        title="Terms of Service - PG Finder"
        description="Read PG Finder's terms of service to understand the rules and guidelines for using our platform to find and list PG accommodations."
        keywords="terms of service, terms and conditions, PG Finder terms"
