...
useEffect(() => {
  ...
  return (
    <>
      <SEO
        title="Cookie Policy - PG Finder"
        description="Learn about how PG Finder uses cookies and tracking technologies to improve your experience on our platform."
        keywords="cookie policy, cookies, tracking, PG Finder cookies"
        url="/cookie_policy"
        noindex={true}
      />
