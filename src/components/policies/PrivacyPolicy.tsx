...
useEffect(() => {
  ...
  return (
    <>
      <SEO
        title="Privacy Policy - PG Finder"
        description="Read PG Finder's privacy policy to understand how we collect, use, and protect your personal information when you use our platform to find PG accommodations."
        keywords="privacy policy, data protection, PG Finder privacy"
        url="/privacy_policy"
        noindex={true}
      />
