    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white py-10">
      <div className="max-w-xl mx-auto px-4">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          ...
          <p className="text-gray-500 mb-6">Manage your personal info and password</p>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-3 py-2 block w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
            ...
            <div className="flex items-center pt-2">
              ...
              />
              <label htmlFor="change-password" className="ml-2 text-sm text-gray-900 select-none">
                Change password
              </label>
            </div>
            {/* Password Fields */}
            ...
            <div>
              <button
                type="submit"
                disabled={saving}
                className="w-full flex justify-center items-center gap-2 py-3 px-4 rounded-lg text-base font-semibold text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {saving ? (
                  <>
